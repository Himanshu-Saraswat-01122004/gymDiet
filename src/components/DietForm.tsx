...
import { Target, Weight, User, Zap, Dumbbell, Ruler, Bot, Loader, Leaf, Drumstick, Egg, Globe } from 'lucide-react';
    ...
    <div className="w-full max-w-3xl p-8 space-y-6 bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 py-3 px-4 mt-6 font-semibold text-white rounded-lg shadow-lg transition-all duration-300 ease-in-out bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
